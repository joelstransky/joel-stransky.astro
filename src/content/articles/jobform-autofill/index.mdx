...
image: 'assets/jobform-autofill/cover.png'
tag: [Chrome Extension, AI Code, UI/UX, Productivity]
layoutType: article
---

import { Image } from 'astro:assets';
import popupImg from '../../../assets/jobform-autofill/popup.png';
